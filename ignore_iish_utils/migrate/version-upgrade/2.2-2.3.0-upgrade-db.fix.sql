...
--skip \i 2.2.0-2.2.1-upgrade-db.sql
--skip \i 2.2.1-2.2.2-upgrade-db.sql
--skip \i 2.2.2-2.2.3-upgrade-db.sql
--skip \i 2.2.3-2.2.4-upgrade-db.sql
--skip \i 2.2.4-2.2.5-upgrade-db.sql
...
-- skip ALTER TABLE vandelay.import_item_attr_definition
-- skip     ADD COLUMN internal_id TEXT;

-- skip ALTER TABLE vandelay.import_item
-- skip     ADD COLUMN internal_id BIGINT;
