...
--skip DROP FUNCTION vandelay.get_expr_from_match_set( INTEGER );
--skip DROP FUNCTION vandelay.get_expr_from_match_set_point( vandelay.match_set_point );
--skip DROP FUNCTION vandelay._get_expr_push_jrow( vandelay.match_set_point );
